...
Function InitializeReleaseVars {
	...
	$Env:RELEASE_ZIPBALL = "mustache_${Env:PLATFORM}_${Env:VC_VER}_${Env:PHP_VER}_${Env:APPVEYOR_BUILD_VERSION}"
}
...
Function InstallSdk {
	...
	$RemoteUrl = "https://github.com/Microsoft/php-sdk-binary-tools/archive/php-sdk-${Env:PHP_SDK_BINARY_TOOLS_VER}.zip"
...
Function AppendSessionPath {
	[string[]] $PathsCollection = @(
		...
		"C:\Projects\output\bin",
		"C:\Projects\output\lib",
		"C:\Projects\output"
	)
...
Function PrepareReleasePackage {
	...
	Copy-Item "${Env:RELEASE_FOLDER}\php_mustache.dll" "${PackagePath}"
